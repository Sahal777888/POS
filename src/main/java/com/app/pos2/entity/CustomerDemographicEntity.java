...
@Setter
@Entity
@Table(name="customer_demographic_tab")
public class CustomerDemographicEntity {
    @Id
    @Column(name = "id", length = 36)
    private String id;
    @Column(name = "customer_desc", length = 150)
    ...
    public CustomerDemographicEntity(String id) {
        this.id = id;
    }

    public CustomerDemographicEntity(CustomerDemographicModel model) {
